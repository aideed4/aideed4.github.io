$(document).ready(function () {
    ...
    function populateIntro() {
        ...
        var introContent = $("<p id='intro-text'>My name is <span class='red-text'>Abdullahi</span>. <br>I'm a <span class='red-text'>full stack web developer</span>. <br>Welcome to my portfolio site!</p>");
    ...
    function populateAbout() {
        ...
        var aboutContent = $("<p id='about-text'>I'm a full stack web developer. I'm always looking to improve my skills inorder to stay up to date with many advancment in the technology world. i have created few projects and many exciting others are on the way. Again welcome to my page :). </p>")
    ...
    function populateContact() {
        ...
        var contactContent2 = $("<p class='contact-text' class='left-align' style='padding-bottom: 5%'>Email: <br><span class='red-text'><a href='mailto:abdullahiaideed@gmail.com@gmail.com'>abdullahiaideed@gmail.com</a></span></p>")
        var imgrow = $("<div class='row'></div>");
        var githubImgDiv=$("<div class='col s6'><a href='https://github.com/aideed4' target='_blank'><img class='responsive-img ourImage' src='assets/img/githublogo.jpg'></a></div>");
        var linkedinImgDiv=$("<div class='col s6'><a href='' target='_blank'><img class='responsive-img ourImage' src='assets/img/linkedinlogo.jpg'></a></div>");
    ...
    function populatePortfolio() {
        ...
        var projcard1 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/gifwebpagethumbnail.jpg'><span style='font-size:1.40em;' class='card-title white-text red'>Giftastic Web App</span></div><div class='card-content'><p class='card-textcontent'>A web page using the GIPHY API to generate button categories which then generate gifs</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://aideed4.github.io/giftastics/' target='_blank'>View Project</a></div></div>");
        var projcard2 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/triviaquestiongamethumbnail.jpg'><span style='font-size:1.40em;' class='card-title white-text red'>Trivia Question Game</span></div><div class='card-content'><p class='card-textcontent'>A timed true and false trivia question game created using JavaScript timeout functions</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://aideed4.github.io/TriviaGame/' target='_blank'>View Project</a></div></div>");
        var projcard3 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/time4colorboxthumbnail.jpg'><span style='font-size:1.40em;' class='card-title white-text red'> health & Wellness site</span></div><div class='card-content'><p class='card-textcontent'>A website that will help you achieve your health goals. wheather you want to gain or loose weight</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://timsmith78.github.io/team6proj1/home.html' target='_blank'>View Project</a></div></div>");
        var projcard4 = $("<div class='col s12 m6 l4'><div class='card medium'><div class='card-image'><img src='assets/images/cookieFinderPic.JPG'><span style='font-size:1.40em;' class='card-title white-text red'>psychic game App</span></div><div class='card-content'><p class='card-textcontent'>simple JavaScript game that allows you to guess the letter the computer chooses.</p></div><a style='font-size:1.40em;padding:10px;' class='red-text' href='https://aideed4.github.io/Psychic_Game/' target='_blank'>View Project</a></div></div>");
